...
@attr.s
class CreateCalendarReqPermissions(object):
    pass


@attr.s
class CreateCalendarReq(object):
    summary: str = attr.ib(
        default="", metadata={"req_type": "json", "key": "summary"}
    )  # 日历标题, 示例值："测试日历", 最大长度：`255` 字符
    description: str = attr.ib(
        default="", metadata={"req_type": "json", "key": "description"}
    )  # 日历描述, 示例值："使用开放接口创建日历", 最大长度：`255` 字符
    permissions: lark_type_enum.CalendarPermission = attr.ib(
...
@attr.s
class CreateCalendarRespCalendarRole(object):
    pass


@attr.s
class CreateCalendarRespCalendarType(object):
    pass


@attr.s
class CreateCalendarRespCalendarPermissions(object):
    pass


@attr.s
class CreateCalendarRespCalendar(object):
    ...
    permissions: CreateCalendarRespCalendarPermissions = attr.ib(
        factory=lambda: CreateCalendarRespCalendarPermissions(),
    ...
    type: CreateCalendarRespCalendarType = attr.ib(
        factory=lambda: CreateCalendarRespCalendarType(),
    ...
    role: CreateCalendarRespCalendarRole = attr.ib(
        factory=lambda: CreateCalendarRespCalendarRole(),
...
@attr.s
class CreateCalendarResp(object):
    calendar: CreateCalendarRespCalendar = attr.ib(
        default=None, metadata={"req_type": "json", "key": "calendar"}
    )  # 新创建的日历实体


def _gen_create_calendar_req(request, options) -> RawRequestReq:
    return RawRequestReq(
        dataclass=CreateCalendarResp,
        scope="Calendar",
        api="CreateCalendar",
        method="POST",
