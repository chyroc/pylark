...
@attr.s
class GetHireNoteReqUserIDType(object):
    pass


@attr.s
class GetHireNoteReq(object):
    user_id_type: GetHireNoteReqUserIDType = attr.ib(
...
@attr.s
class GetHireNoteRespNote(object):
...
@attr.s
class GetHireNoteResp(object):
    note: GetHireNoteRespNote = attr.ib(
        default=None, metadata={"req_type": "json"}
    )  # 备注数据


def _gen_get_hire_note_req(request, options) -> RawRequestReq:
    return RawRequestReq(
        dataclass=GetHireNoteResp,
        scope="Hire",
        api="GetHireNote",
        method="GET",
