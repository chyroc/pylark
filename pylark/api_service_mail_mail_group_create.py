...
@attr.s
class CreateMailGroupReq(object):
    email: str = attr.ib(
        default="", metadata={"req_type": "json"}
    )  # 邮件组地址, 示例值："test_mail_group@xxx.xx"
    name: str = attr.ib(
        default="", metadata={"req_type": "json"}
...
@attr.s
class CreateMailGroupResp(object):
...
def _gen_create_mailgroup_req(request, options) -> RawRequestReq:
    return RawRequestReq(
        dataclass=CreateMailGroupResp,
        scope="Mail",
        api="CreateMailGroup",
        method="POST",
