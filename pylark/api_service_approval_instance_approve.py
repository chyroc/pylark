...
@attr.s
class ApproveApprovalInstanceReq(object):
...
@attr.s
class ApproveApprovalInstanceResp(object):
    pass


def _gen_approve_approval_instance_req(request, options) -> RawRequestReq:
    return RawRequestReq(
        dataclass=ApproveApprovalInstanceResp,
        scope="Approval",
