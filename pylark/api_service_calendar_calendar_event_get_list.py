...
@attr.s
class GetCalendarEventListRespItemLocationLongitude(object):
    pass


@attr.s
class GetCalendarEventListRespItemLocationLatitude(object):
    pass
...
def _gen_get_calendar_event_list_req(request, options) -> RawRequestReq:
    return RawRequestReq(
        dataclass=GetCalendarEventListResp,
        scope="Calendar",
