...
class CreateAttendanceUserApprovalReqUserApprovalLeaveI18nNames(object):
    ch: str = attr.ib(default="", metadata={"req_type": "json", "key": "ch"})  # 中文描述
    en: str = attr.ib(default="", metadata={"req_type": "json", "key": "en"})  # 英文描述
    ja: str = attr.ib(default="", metadata={"req_type": "json", "key": "ja"})  # 日文描述
