...
@attr.s
class UpdateDepartmentReqI18nName(object):
    zh_cn: str = attr.ib(
...
@attr.s
class UpdateDepartmentReqDepartmentIDType(object):
    pass


@attr.s
class UpdateDepartmentReqUserIDType(object):
    pass
...
@attr.s
class UpdateDepartmentRespDepartmentStatus(object):
...
@attr.s
class UpdateDepartmentRespDepartmentI18nName(object):
    zh_cn: str = attr.ib(
        default="", metadata={"req_type": "json", "key": "zh_cn"}
    )  # 部门的中文名
    ja_jp: str = attr.ib(
...
@attr.s
class UpdateDepartmentResp(object):
    department: UpdateDepartmentRespDepartment = attr.ib(
        default=None, metadata={"req_type": "json", "key": "department"}
    )  # 部门信息


def _gen_update_department_req(request, options) -> RawRequestReq:
    return RawRequestReq(
        dataclass=UpdateDepartmentResp,
        scope="Contact",
