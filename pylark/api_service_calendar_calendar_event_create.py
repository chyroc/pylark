...
@attr.s
class CreateCalendarEventReqSchema(object):
    ui_name: str = attr.ib(
...
@attr.s
class CreateCalendarEventReqReminder(object):
    minutes: int = attr.ib(
...
@attr.s
class CreateCalendarEventReqLocationLongitude(object):
    pass


@attr.s
class CreateCalendarEventReqLocationLatitude(object):
    pass


@attr.s
class CreateCalendarEventReqLocation(object):
    name: str = attr.ib(
        default="", metadata={"req_type": "json"}
...
@attr.s
class CreateCalendarEventReqVchat(object):
    vc_type: str = attr.ib(
        default="", metadata={"req_type": "json"}
...
@attr.s
class CreateCalendarEventReq(object):
    ...
    start_time: CreateCalendarEventReqStartTime = attr.ib(
        default=None, metadata={"req_type": "json"}
    )  # 日程开始时间
    end_time: CreateCalendarEventReqEndTime = attr.ib(
        default=None, metadata={"req_type": "json"}
    )  # 日程结束时间
    vchat: CreateCalendarEventReqVchat = attr.ib(
        default=None, metadata={"req_type": "json"}
    ...
    location: CreateCalendarEventReqLocation = attr.ib(
        default=None, metadata={"req_type": "json"}
    )  # 日程地点
    color: int = attr.ib(
        default=0, metadata={"req_type": "json"}
    )  # 日程颜色，颜色RGB值的int32表示。仅对当前身份生效；客户端展示时会映射到色板上最接近的一种颜色；值为0或-1时默认跟随日历颜色。, 示例值：-1
    reminders: typing.List[CreateCalendarEventReqReminder] = attr.ib(
    ...
    schemas: typing.List[CreateCalendarEventReqSchema] = attr.ib(
        factory=lambda: [], metadata={"req_type": "json"}
    )  # 日程自定义信息


@attr.s
class CreateCalendarEventRespEventSchema(object):
    ui_name: str = attr.ib(
        default="", metadata={"req_type": "json"}
...
@attr.s
class CreateCalendarEventRespEventReminder(object):
    minutes: int = attr.ib(
        default=0, metadata={"req_type": "json"}
...
@attr.s
class CreateCalendarEventRespEventLocationLongitude(object):
    pass


@attr.s
class CreateCalendarEventRespEventLocationLatitude(object):
    pass


@attr.s
class CreateCalendarEventRespEventLocation(object):
...
@attr.s
class CreateCalendarEventRespEventVchat(object):
    vc_type: str = attr.ib(
        default="", metadata={"req_type": "json"}
...
@attr.s
class CreateCalendarEventRespEventEndTime(object):
    date: str = attr.ib(
        default="", metadata={"req_type": "json"}
...
@attr.s
class CreateCalendarEventRespEventStartTime(object):
    date: str = attr.ib(
        default="", metadata={"req_type": "json"}
    )  # 仅全天日程使用该字段，如2018-09-01。需满足 RFC3339 格式。不能与 timestamp 同时指定
    timestamp: str = attr.ib(
...
@attr.s
class CreateCalendarEventRespEvent(object):
    ...
    start_time: CreateCalendarEventRespEventStartTime = attr.ib(
        default=None, metadata={"req_type": "json"}
    )  # 日程开始时间
    end_time: CreateCalendarEventRespEventEndTime = attr.ib(
        default=None, metadata={"req_type": "json"}
    )  # 日程结束时间
    vchat: CreateCalendarEventRespEventVchat = attr.ib(
        default=None, metadata={"req_type": "json"}
    )  # 视频会议信息，仅当日程至少有一位attendee时生效
    visibility: str = attr.ib(
        default="", metadata={"req_type": "json"}
    ...
    location: CreateCalendarEventRespEventLocation = attr.ib(
        default=None, metadata={"req_type": "json"}
    )  # 日程地点
    color: int = attr.ib(
        default=0, metadata={"req_type": "json"}
    )  # 日程颜色，颜色RGB值的int32表示。仅对当前身份生效；客户端展示时会映射到色板上最接近的一种颜色；值为0或-1时默认跟随日历颜色。
    reminders: typing.List[CreateCalendarEventRespEventReminder] = attr.ib(
        factory=lambda: [], metadata={"req_type": "json"}
    )  # 日程提醒列表
    recurrence: str = attr.ib(
        default="", metadata={"req_type": "json"}
    ...
    schemas: typing.List[CreateCalendarEventRespEventSchema] = attr.ib(
        factory=lambda: [], metadata={"req_type": "json"}
    )  # 日程自定义信息


@attr.s
class CreateCalendarEventResp(object):
    event: CreateCalendarEventRespEvent = attr.ib(
        default=None, metadata={"req_type": "json"}
    )  # 新创建的日程实体


def _gen_create_calendar_event_req(request, options) -> RawRequestReq:
    return RawRequestReq(
        dataclass=CreateCalendarEventResp,
        scope="Calendar",
