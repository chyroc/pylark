...
@attr.s
class UpdateUserPatchReqCustomAttrValueGenericUser(object):
    id: str = attr.ib(
...
@attr.s
class UpdateUserPatchReqCustomAttrValue(object):
    text: str = attr.ib(
        default="", metadata={"req_type": "json"}
    ...
    generic_user: UpdateUserPatchReqCustomAttrValueGenericUser = attr.ib(
...
class UpdateUserPatchReqCustomAttr(object):
    ...
    value: UpdateUserPatchReqCustomAttrValue = attr.ib(
        default=None, metadata={"req_type": "json"}
    )  # 自定义字段取值


@attr.s
class UpdateUserPatchReqOrder(object):
...
@attr.s
class UpdateUserPatchReqDepartmentIDType(object):
    pass


@attr.s
class UpdateUserPatchReqUserIDType(object):
    pass


@attr.s
class UpdateUserPatchReq(object):
    user_id_type: UpdateUserPatchReqUserIDType = attr.ib(
    ...
    department_id_type: UpdateUserPatchReqDepartmentIDType = attr.ib(
        default=None, metadata={"req_type": "query"}
    ...
    custom_attrs: typing.List[UpdateUserPatchReqCustomAttr] = attr.ib(
        factory=lambda: [], metadata={"req_type": "json"}
...
class UpdateUserPatchRespUserCustomAttrValue(object):
    ...
    generic_user: UpdateUserPatchRespUserCustomAttrValueGenericUser = attr.ib(
        default=None, metadata={"req_type": "json"}
    )  # 字段类型为 GENERIC_USER 时，该参数定义引用人员
...
@attr.s
class UpdateUserPatchRespUserOrder(object):
    department_id: str = attr.ib(
        default="", metadata={"req_type": "json"}
    )  # 排序信息对应的部门ID
    user_order: int = attr.ib(
...
@attr.s
class UpdateUserPatchRespUserStatus(object):
    is_frozen: bool = attr.ib(
...
@attr.s
class UpdateUserPatchRespUserAvatar(object):
...
@attr.s
class UpdateUserPatchRespUser(object):
    ...
    avatar: UpdateUserPatchRespUserAvatar = attr.ib(
        default=None, metadata={"req_type": "json"}
    )  # 用户头像信息,**字段权限要求（满足任一）**：, 获取用户基本信息, 以应用身份访问通讯录（历史版本）
    status: UpdateUserPatchRespUserStatus = attr.ib(
        default=None, metadata={"req_type": "json"}
    ...
    custom_attrs: typing.List[UpdateUserPatchRespUserCustomAttr] = attr.ib(
        factory=lambda: [], metadata={"req_type": "json"}
    )  # 自定义字段,**字段权限要求（满足任一）**：, 获取用户雇佣信息, 以应用身份访问通讯录（历史版本）
    enterprise_email: str = attr.ib(
        default="", metadata={"req_type": "json"}
    ...
    notification_option: UpdateUserPatchRespUserNotificationOption = attr.ib(
        default=None, metadata={"req_type": "json"}
    )  # 创建用户的邀请方式
    is_frozen: bool = attr.ib(
        factory=lambda: bool(), metadata={"req_type": "json"}
...
@attr.s
class UpdateUserPatchResp(object):
    user: UpdateUserPatchRespUser = attr.ib(
        default=None, metadata={"req_type": "json"}
    )  # 用户信息


def _gen_update_user_patch_req(request, options) -> RawRequestReq:
    return RawRequestReq(
        dataclass=UpdateUserPatchResp,
        scope="Contact",
        api="UpdateUserPatch",
        method="PATCH",
